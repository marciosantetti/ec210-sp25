...
As of January 2025, the U.S. [civilian unemployment rate]{.hi-slate} is of [4.0%]{.note}.
...
. . .
  ...
  - Relating these [4.0%]{.note} with [GDP]{.hi-orange}?
  
. . .

  - Relating these [4.0%]{.note} with those [employed]{.hi-slate}? 
  
. . .

  - And why should one [care]{.hi-pink} about these [4.0%]{.note} at all? 
...
![Source: U.S. Bureau of Labor Statistics.](chart.png){fig-align="center" width="1400" height="500"}
